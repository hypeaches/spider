...
commandline = "https://www.bbiquge.com/book_110354/"
...
def save_novel_index():
    ...
    response = urllib.request.urlopen(index_html, context=context)
...
def parse_novel_list():
    global novel_list
    line_list = get_novel_list_table().split("<dd>")
